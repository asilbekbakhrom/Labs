...
>  Ikki arrayni bitta tartiblangan arrayda birlashtiring. Array birinchi ikkita array tugunlarini birlashtirish orqali tuzilishi kerak.
...
| Input | Output |
| - | - |
| `1 2 4`<br>`1 3 4`<br>>`1 1 2 3 4 4`<br>`
###### Namuna 2
| Input | Output |
| - | - |
| ``<br>`0`<br>>`0`<br>`
